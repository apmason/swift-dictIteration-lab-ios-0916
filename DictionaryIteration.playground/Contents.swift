...
if let nevermind = bestSellingAlbum[bandName] {
    print("\(bandName)'s top-selling album was \(nevermind)")
}
 ...
 */
//Array? Or whatever type the dictionary was
 ...
 */
// write your code here
let gradeAverage = [9: "B", 10: "A", 11: "C", 12: "B"]
 ...
 */
// write your code here
for (grade, average) in gradeAverage {
    print("Grade \(grade) got \(average)")
}
...
for (grade, average) in gradeAverage {
    if average == "A" {
        print("Grade \(grade) got the highest score with \(average)!")
    }
}
